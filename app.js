...
app.use(function (req, res, next) {
    res.setHeader('X-Powered-By', 'WeiJie Gao');
    res.setHeader('Donate-Me', 'gaowebhost@yahoo.com (This is a alipay account)');
    res.setHeader('HomePage', 'http://wwwwww.cf');
    

    var encrypted = (req.protocol || 'http')==='https';
    app.locals['constant'] = {
        name: config.name || 'AladdinMagicSearch',
        encrypted: encrypted,
